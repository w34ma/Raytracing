/***********************************************************
     ...
     This code was originally written by Jack Wang for
		...
		data structures of the raytracer.  
		Simple traversal and addition code to 
		the data structures are given to you.
...
private:
	...
	Colour shadeRay( Ray3D& ray ,int times_reflec,int times_refrac);
    /***************************************************************/
   // Colour reflection_calc( Ray3D& ray,int times_reflec);
   // Colour refraction_calc( Ray3D& ray,int times_refrac);
    //to cache the worldToModel transfromations first to improve efficiency
    void scfCache( SceneDagNode* node);
    /***************************************************************/
